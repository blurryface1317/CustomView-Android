package com.sew.customviewlibrary;
...
public class CustomView extends LinearLayout {
    ...
    public CustomView(Context context, AttributeSet attrs) {
        ...
        try {
            numberColor = typedArray.getColor(R.styleable.CustomView_numberColor, getResources().getColor(android.R.color.background_dark, null));
            valueColor = typedArray.getColor(R.styleable.CustomView_valueColor, getResources().getColor(android.R.color.background_dark, null));
            plusButtonColor = typedArray.getColor(R.styleable.CustomView_plusButtonColor, getResources().getColor(android.R.color.background_dark, null));
            minusButtonColor = typedArray.getColor(R.styleable.CustomView_minusButtonColor, getResources().getColor(android.R.color.background_dark, null));
